...
def organizar_produto(texto: str) -> dict[str, str]:
    ...
    # Primeiro tentamos encontrar quantidade + unidade no valor associado
    # ao rótulo QUANTIDADE.
    ...
    # Se o OCR reconhecer somente o número (por exemplo, "5"), ainda
    # podemos aproveitá-lo porque a unidade pode ser escolhida na tela.

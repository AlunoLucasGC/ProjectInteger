-- Esquema SQLite do Feira Fácil.
-- O banco inteiro é armazenado em feira_facil.db.
...
-- Contas do sistema.
-- consumidor: acesso ao catálogo/perfil.
-- produtor: precisa ser aprovado antes de publicar.
-- admin: aprova/rejeita produtores.
CREATE TABLE IF NOT EXISTS tb_usuarios (
    ...
    status TEXT NOT NULL DEFAULT 'ativo' CHECK (status IN ('ativo', 'pendente', 'rejeitado')),
    documento TEXT,
    data_cadastro TEXT DEFAULT CURRENT_TIMESTAMP,
